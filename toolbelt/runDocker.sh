...
MQTT_LOAD_RANDOMIZED_CLIENT_STEP_INTERVAL=10000
...
docker run $INTERACTIVITY $CLEANUP $JMX_OPTIONS $DEBUG_OPTIONS \
     ...
     -e MQTT_LOAD_TOPIC_GROUPS_NUMBER=$MQTT_LOAD_TOPIC_GROUPS_NUMBER \
     ...
     -e MQTT_LOAD_RANDOMIZED_CLIENT_STEP_INTERVAL=$MQTT_LOAD_RANDOMIZED_CLIENT_STEP_INTERVAL \
